          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="flex-1 text-center sm:text-start">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 mt-2">
                ...
                {score && (
                  <StarRating score={technicien.score} size={16} />
                )}
                {technicien.badge && (
                ...
                <div key={a.id} className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[var(--radius-md)] p-4">
                  <div className="flex items-center justify-between mb-2">
                    <div className="inline-flex items-center gap-1.5">
                      <StarRating score={a.note * 10} size={14} showScore={false} />
                    ...
                    <div className="flex items-center justify-between text-xs text-[var(--color-text-muted)]">
                      {g.avis_note != null && (
                        <span className="inline-flex items-center gap-1 font-semibold text-[var(--color-secondary)]">
                          <StarRating score={g.avis_note * 10} size={12} showScore={false} />
                          <span className="ml-1">{g.avis_note}/10</span>
                        </span>
                      )}
                      {g.date_service && (
